...
Version  : 1.4.1
Release  : 93
URL      : https://cran.r-project.org/src/contrib/stringr_1.4.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/stringr_1.4.1.tar.gz
Summary  : Simple, Consistent Wrappers for Common String Operations
Group    : Development/Tools
License  : GPL-2.0
Requires: R-stringr-license = %{version}-%{release}
Requires: R-glue
Requires: R-magrittr
Requires: R-stringi
...
%package license
Summary: license components for the R-stringr package.
Group: Default

%description license
license components for the R-stringr package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661195496

%install
export SOURCE_DATE_EPOCH=1661195496
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/R-stringr
cp %{_builddir}/stringr/LICENSE %{buildroot}/usr/share/package-licenses/R-stringr/4cc77b90af91e615a64ae04893fdffa7939db84c
export LANG=C.UTF-8
...
/usr/share/package-licenses/R-stringr/4cc77b90af91e615a64ae04893fdffa7939db84c
