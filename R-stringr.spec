...
Version  : 1.3.1
Release  : 59
URL      : https://cran.r-project.org/src/contrib/stringr_1.3.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/stringr_1.3.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1537767077
